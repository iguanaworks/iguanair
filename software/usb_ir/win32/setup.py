...
Filename: "SCHTASKS"; Parameters: "/Create /TN ""Trigger Igdaemon Rescan"" /TR ""'{app}\igdaemon.exe' --rescan"" /SC ONEVENT /EC System /MO ""*[System[Provider[@Name='Microsoft-Windows-Power-Troubleshooter'] and EventID=1]]"" /RU SYSTEM /F"; Flags: runhidden
