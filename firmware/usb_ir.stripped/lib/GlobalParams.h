...
#define CPU_CLOCK_SPEED_MASK   0x3     //CPU Clock Speed mask
#define CPU_CLOCK_SPEED_JUST   0x3     //CPU Clock Speed value justified

#define TIMER_CLOCK            0x3     //Timer Clock value
#define TIMER_CLOCK_MASK       0x3     //Timer Clock mask
#define TIMER_CLOCK_JUST       0x3     //Timer Clock value justified

#define TIMER_CLOCK_SPEED      0x3     //Timer Clock Speed value
#define TIMER_CLOCK_SPEED_MASK 0xc     //Timer Clock Speed mask
#define TIMER_CLOCK_SPEED_JUST 0xc     //Timer Clock Speed value justified
