...
export LoadConfig_usb_ir_body
export _LoadConfig_usb_ir_body
...
;---------------------------------------------------------------------------
; Load Configuration usb_ir_body
;
;    Load configuration registers for usb_ir_body.
...
;               CUR_PP
;
_LoadConfig_usb_ir_body:
 LoadConfig_usb_ir_body:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_usb_ir_body            ; Call load config table routine
